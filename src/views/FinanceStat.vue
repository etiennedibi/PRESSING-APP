<template>
  <div class="bodyBox">
    <div class="TheBoxBody">
      <div class="leHerder">
        <p class="sectionTitle">Statistiques Finanacières</p>
...
export default {
  ...
  methods: {
    ...
    // ------------------------
    updateChart() {
      this.series = this.FinanceAnalytics.GraphData.series;
      this.productchartOptions = {
        ...this.productchartOptions,
        ...{
          xaxis: {
            categories: this.FinanceAnalytics.GraphData.month,
          },
        },
      };
    },
    ...
    perodeDef() {
      ...
      this.$store.dispatch("init_finance_analitic", this.travelAnalyticsPeriod);
      setTimeout(() => {
        this.updateChart();
        this.showChart = true;
      }, 500);
