        ...
        <v-card-text>
          <v-container class="showDialog">
            ...
            <div class="statElment">
              <div>
                <h5>NOM</h5>
                <h4 style="font-weight:normal; text-align:justify;font-size:12px">{{ editedItem.nom_complet }} 
                </h4>
              </div>
            </div>
             <div class="statElment">
             ...
             <div class="statElment">
              <div>
                <h5>EMAIL</h5>
                <h4 style="font-weight:normal; text-align:justify;font-size:12px;">{{ editedItem.email }} 
                </h4>
              </div>
            </div>
